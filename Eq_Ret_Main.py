...
region = ['NJ']#['AL', 'AZ', 'AR', 'CA', 'CO', 'CT', 'DE', 'FL', 'GA', 'ID', 'IL', 'IN', 'IA', 'KS', 'KY', 'LA', 'ME', 'MD', 'MA', 'MI', 'MN', 'MS', 'MO', 'MT', 'NE', 'NV', 'NH', 'NJ', 'NM', 'NY', 'NC', 'ND', 'OH', 'OK', 'OR', 'PA', 'RI', 'SC', 'SD', 'TN', 'TX', 'UT', 'VT', 'VA', 'WA', 'WV', 'WI', 'WY']#['VA']#['NY','PA','OH','WV','KY','TN','VA','MD','DE','NC','NJ']  #['DE']# 
...
n = 1
while n <= Steps:
    Results = OL.StepDown(Results,CONEF,REOMEF,EFType, numYears,MAXCAP,SITEMAXCAP,reSites,plants,SITEMINCAP,mCapDF,threshDist,coalPlants,region,SMR_bool,folderName,solFileName, winFileName,DiscRate, PartNumber = 2, criteria_Series = 'Unweighted Objective', criteria_tolerance = 0.20, SMRs = SMR_Values)
